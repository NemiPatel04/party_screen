...
import 'package:party_app/FindEvent.dart';
      ...
      body: Container(
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage('assets/images/The-Weeknd.png'),
                fit: BoxFit.cover
          )
        ),
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              FadeAnimation(1, Text('Find the best location near you for a good night.',
